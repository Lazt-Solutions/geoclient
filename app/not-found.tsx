...
export default function NotFoundPage() {
    ...
    return (
        <>
            <section className="grid place-content-center gap-6 text-center flex-1">
                ...
                <div className="text-sm md:text-base flex flex-col md:flex-row justify-center items-center gap-4">
                    <GeoActionLink href="/" >
            ...
            <footer className="space-y-6 mt-auto pt-10 border-t border-muted text-center">
